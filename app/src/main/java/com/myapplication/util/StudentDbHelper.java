    ...
    public LinkedList<Student> readStudents(String stuNumber) {
        ...
        if(cursor.moveToFirst()) {
            do {
                ...
                @SuppressLint("Range") String stuMajor = cursor.getString(cursor.getColumnIndex("stuMajor"));
                @SuppressLint("Range") String stuPhone = cursor.getString(cursor.getColumnIndex("stuPhone"));
                @SuppressLint("Range") String stuQq = cursor.getString(cursor.getColumnIndex("stuQq"));
                @SuppressLint("Range") String stuAddress = cursor.getString(cursor.getColumnIndex("stuAddress"));
